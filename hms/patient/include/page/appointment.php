		...
		<div class="row">
			<div class="col-md-12">
				...
				<?php
						...
						$sql=mysqli_query($con,"select doctors.doctorName as docname,doctors.*, appointment.*  from appointment join doctors on doctors.id=appointment.doctorId where appointment.userId='".$_SESSION['id']."' LIMIT $start, $limit");
						$cnt=1;
						...
						<div class="panel panel-default">
						  <div class="panel-heading">
							<h4 class="panel-title" data-toggle="collapse" href="#collapse<?php echo $cnt;?>">
								<div class="row">	
									<img class="col-xs-3 col-sm-1 col-lg-1 img-circle border border-secondary" src="data:image/jpg;charset=utf8;base64,<?php if (!empty($row['customer_image'])) { echo base64_encode($row['customer_image']); } else { echo $default_image; } ?>" width="30" height="30"></img>
									<div class="col-xs-3 col-sm-5 col-lg-5">
										<b><?php echo $row['docname'];?></b>
										<br /><small><?php echo $row['doctorSpecialization']; ?></small>
									</div>
									<div class="col-xs-3 col-sm-2 col-lg-2">
										<p><?php echo $row['appointmentDate'];?> / <?php echo $row['appointmentTime'];?></p>
									</div>
				...
				<?php
					$count=mysqli_query($con,"SELECT COUNT(*) FROM appointment JOIN doctors ON doctors.id=appointment.doctorId WHERE appointment.userId='".$_SESSION['id']."'");
					...
					if( $total_records >= $limit) {
						echo "<div class=\"text-right\"><ul class=\"pagination\">";
							for ($i = 1; $i <= $total_pages; $i++) { 
								if($i == $pn) {
									echo "<li class='active'><a href='dashboard.php?page=appointment&pn=" . $i . "'>" . $i . "</a></li>";
								} else {
									echo "<li><a href='dashboard.php?page=appointment&pn=" . $i . "'>" . $i . "</a></li>";
								}	
							}
						echo "</ul></div>";
					}
