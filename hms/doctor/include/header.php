		...
		<ul class="nav navbar-right">					
			<li class="dropdown current-user">
				<a href class="dropdown-toggle" data-toggle="dropdown">
					<img class="img-circle border border-secondary" src="data:image/jpg;charset=utf8;base64,<?php if (!empty($row['customer_image'])) { echo base64_encode($row['customer_image']); } else { echo $default_image; } ?>" > <span class="username">
