...
<!--
	Filename			:	outOfStock.php
	Description			:	Module responsible for managing out of stock medicines.
			...
			<div class="col-md-12">
				<p style="color:red;">
					...
					<?php
						...
						$sql=mysqli_query($con,"SELECT * FROM tblpharmamedicines WHERE medicine_quantity < 5 LIMIT $start, $limit");
						$cnt=1;
					...
					$count=mysqli_query($con,"SELECT COUNT(*) FROM tblpharmamedicines WHERE medicine_quantity < 5");
